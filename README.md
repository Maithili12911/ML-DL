1. Please type following commands to run the code :
cd frontend
npm run dev 
after running these 2 commands both frontend and backend get triggered 
Please click on URL : Frontend URL of local host (http://localhost:5173/)
